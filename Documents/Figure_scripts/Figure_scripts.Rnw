...
plot_coverage_power(table_results, parameter_labels = c("$\\beta_1$","$\\beta_2$","$\\beta_3$"), method_labels = c("ML", "Bayesian default", "Reasonable prior","Experts prior"), criteria_labels = c("Coverage", "Power"))+
